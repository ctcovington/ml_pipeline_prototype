...
rule merge_subsets:
    ...
    shell:
        ...
        rm -rf log/02_*
        source activate ml_pipeline
        python scripts/python/02_merge_subsets.py {params.data_dir} {params.unit_id} >log/02_merge_subsets.out 2>log/02_merge_subsets.err
        source deactivate
        """
...
rule subset_save:
    ...
    shell:
        ...
        rm -rf log/01_*
        source activate ml_pipeline
        python scripts/python/01_subset_and_save.py {params.data_dir} {params.unit_id} {params.count_files} {params.non_count_files} {params.missingness_threshold_count} {params.missingness_threshold_non_count} >log/01_subset_and_save.out 2>log/01_subset_and_save.err
        source deactivate
        """
...
rule csv_to_parquet:
    ...
    shell:
        ...
        rm -rf log/00_*
        source activate ml_pipeline
        python scripts/python/00_csv_to_parquet.py {params.feature_dir} {params.data_dir} >log/00_csv_to_parquet.out 2>log/00_csv_to_parquet.err
        source deactivate
        """
